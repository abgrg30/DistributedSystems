...
public class Path implements Iterable<String>, Comparable<Path>, Serializable
{
    ...
    /** Helper function.
      @name checkComponent
      @description checks if given component does not include invalid entries
                   like separator, a colon, or is not an empty string.
    ...
    **/
    ...
    /** Helper function.
      @name checkPath
      @description checks if given Path String does not include invalid entries
                   a colon, or is not an empty string. Also, path should always
    ...
    **/
    ...
    /** Helper function.
      @name setParams
      @description Set the private class members filePath and compList.
    **/
    private void setParams(String path) {
      ...
      // Same as input path.
      // But eliminates any empty path components
    ...
    */
    ...
    {
          return new PathIterator(compList.iterator());
    }
    ...
    public Path parent()
    {
        ...
        for (int i = 0 ; i < compList.size() - 1; i++) {
            sBuffer.append("/").append(compList.get(i));
        }
